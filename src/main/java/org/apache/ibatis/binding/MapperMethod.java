...
/**
 * 每一个MapperMethod对应Mapper接口的一个方法（对即一个mapper文件中配置的一个sql语句）
 * <p><br/>
 * 这个类的地位和java自带的Method类似
 * <p><br/>
 * 实际上每个Method(key)都会映射成MapperMethod(value)
 */
public class MapperMethod {
    /**
     * sql命令, 包含name和type两个字段, 被execute方法执行
     */
    ...
    /**
     * @param mapperInterface mapper接口, mybatis根据这个接口用反射创建代理
     * @param method          来自java反射包(java.lang.reflect)
     */
    ...
    /**
     * 执行自己(在内部进行增删改查的细分), 类似于Method类的invoke方法
     *
     * @param sqlSession 用来执行增删改查
     * @param args       增删改查所需的参数
     */
    ...
    /**
     * 所有带有execute前缀的方法都是用于被execute()调用的
     */
    //结果处理器
    ...
    /**
     * SQL命令，MapperMethod的静态内部类
     */
    public static class SqlCommand {

        /**
         * 对应 &lt select &gt &lt update &gt 等元素的id属性加上namespace前缀
         */
        private final String name;
        /**
         * SqlCommandType为枚举类型, 含insert|update|delete|select, 附加unknown
         */
        private final SqlCommandType type;

        /**
         * @param mapperInterface mapperInterface mapper接口, mybatis根据这个接口用反射创建代理
         * @param method          来自java反射包(java.lang.reflect)
         */

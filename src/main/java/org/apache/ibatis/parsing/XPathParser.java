...
public class XPathParser {
    ...
    /** 根据传入的XPath表达式, 返回XNode对象 */
    public XNode evalNode(String expression) {
        return evalNode(document, expression);
    }

    /**
     * XNode evalNode(String expression)方法的实现
     * 根据expression, 从root开始查找, 返回XNode对象
     */
    ...
    private Object evaluate(String expression, Object root, QName returnType) {
        try {
            ...
            //evaluateXX--求XX的值
            //evaluate求expression的值, 即根据Xpath表达式得到DOM中的对象
    ...
    /**
     * 由构造器调用, 创建出一个Document赋给document字段.<br/>
     * 必须在common constructor之后调用
     */

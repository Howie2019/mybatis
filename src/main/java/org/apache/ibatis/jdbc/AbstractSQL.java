...
public abstract class AbstractSQL<T> {
    ...
    /**
     * 没有实现Appendable接口, 而是持有一个Appendable对象. 采用组合而非继承.
     */
    private static class SafeAppendable {
        //Appendable接口规定实现类可以在其后拼接字符或者字符序列
        //StringBuilder和StringBuffer实现了此接口
        private final Appendable appendable;
        /**
         * 所有新建的SafeAppendable都是空的
         */
        ...
        /**
         * 刚创建的SafeAppendable一定是空的, 每次调用append方法都会更新empty字段
         */

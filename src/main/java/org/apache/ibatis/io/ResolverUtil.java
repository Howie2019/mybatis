...
/**
 * 用于在class path里寻找.class文件, 比如找继承了某个类/实现了某个接口的类, 或者带有某种注解的类
 *
...
public class ResolverUtil<T> {
    ...
    public static interface Test {
         ...
         *
         * @return return True if a class is to be included in the results, false otherwise.
         */
    ...
    public static class IsA implements Test {
        ...
        public boolean matches(Class<?> type) {
            //Determines if the class or interface is either
            // the same as,
     ...
     */
    //最底层的方法, findAnnotated和findImplementations都基于这个方法

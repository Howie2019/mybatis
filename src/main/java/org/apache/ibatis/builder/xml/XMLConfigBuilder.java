...
public class XMLConfigBuilder extends BaseBuilder {
     ...
     * @param environment <environment>元素
     * @param props       props
     */
    ...
    /**
     * 解析.xml(核心配置文件), 根据.xml 来build一个Configuration对象
     * 唯一公有方法
     *
    ...
    private void objectWrapperFactoryElement(XNode context) throws Exception {
        if (context != null) {
            String type = context.getStringAttribute("type");
            WrapperFactory factory = (WrapperFactory) resolveClass(type).newInstance();
            configuration.setWrapperFactory(factory);
        }
    }
     ...
     *
     * @param context <transactionManager>这个节点
     * @return 事务工厂
     * @throws Exception <transactionManager type="jdbc"/>节点的type属性配置错误
     */
    private TransactionFactory transactionManagerElement(XNode context) throws Exception {
        if (context != null) {
            String type = context.getStringAttribute("type");
            Properties props = context.getChildrenAsProperties();
            //根据type返回对应的的TransactionFactory
